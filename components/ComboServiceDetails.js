...
const ComboServiceDetails = ({ service, onBack }) => {
    const leftarrow = "/assets/img/leftarrow.svg";
const noimage = "/assets/img/noimage.svg";
  // ✅ initialize safely even if service is null
    ...
    >
      ...
      <span style={{ fontSize: "14px", color: "#777" }}>No Image</span>
          ...
          <div className="flex-grow-1">
            ...
            <div className="details-listid mt-4">Listed ID: {service.id}</div>
...
export default ComboServiceDetails;
