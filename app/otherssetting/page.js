  ...
  try {
    ...
    if (result.status !== "success") {
      await Swal.fire({
        icon: "error",
        title: "Update Failed",
        text: "Unable to update the Direct Call setting.",
      });
    } else {
      await Swal.fire({
        icon: "success",
        title: "Updated Successfully!",
        text: "Direct Call setting has been saved.",
        timer: 1200,
    ...
    await Swal.fire({
      icon: "error",
      title: "Network Error",
      text: "Unable to update Direct Call. Please try again.",
    });
  }
};
  ...
  try {
    ...
    if (res.status === "success") {
      await Swal.fire({
        ...
        text: "Your payment details have been saved successfully.",
        timer: 1500,
        showConfirmButton: false,
      });
  ...
  try {
    ...
    if (res.status === "success") {
      await Swal.fire({
        ...
        text: "Your delivery configuration has been saved successfully.",
        timer: 1500,
        showConfirmButton: false,
      });
