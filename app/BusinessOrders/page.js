  ...
  useEffect(() => {
                                        ...
                                        <div className="card-header alignings d-flex justify-content-between align-items-center" style={{ background: "transparent" }}>
                                            ...
                                            <div className="d-flex align-items-center w-100 gap-3">
                                                ...
                                                <div className="ms-auto text-end" >
                                                    <img src={savedaddress} width={30} height={30} alt="Saved Address" onClick={() => router.push('/businesssaddress')} style={{cursor:"pointer"}}
                                                    />
                                                </div>
                                            </div>
    ...
    <>
        ...
        {todayNotifications.map((note) => (
            note.type === "combo" ? (
                <div
                    key={`combo-${note.package_id}-${note.notification_id || note.created || Math.random()}`}
                ...
                <div
                    key={`order-${note.notification_id || note.order_number || note.created || Math.random()}`}
                    className="notification-cards"
                    onClick={() => {
                        setSelectedNotification(note);
    ...
    <>
        {previousNotifications.map((note, index) => (
            note.type === "combo" ? (
                <div
                    key={`${note.package_id}-${note.notification_id || index}`}
                    className="notification-cards"
                    onClick={() => {
                        setSelectedNotification(note);
                        fetchPackageNotifications(note.package_id);
                                    ...
                                    {detailedUser && (
                                        <div className="full-screen-panel">
                                            ...
                                            <div className="d-flex gap-3 px-4 mb-4">
                                                ...
                                                >
                                                    <img src={nwhatsapp} width={24} height={24} className='me-3' alt='whatsapp' /> <span style={{ fontFamily: "Manrope", fontSize: "16px", fontWeight: "700", lineHeight: "26px", color: "#FFFFFF" }} >WhatsApp</span>
                                                </Link>
