...
// Keep this import — it's a JS component, not an image
...
const UserOrders = ({ cart, setCart, business, setBusiness }) => {
...
useEffect(() => {
  if (typeof window !== "undefined") {
    ...
    setUser(storedUser);
    setUserId(storedUser.user_id || null);
  }
}, []);
        ...
        setPackageNotifications(prev =>
          prev.map(msg =>
            msg.notification_id === notificationId
              ? { ...msg, isRead: "0" }  // ✅ correct – mark as read
              : msg
          )
        );
 ...
 const getFilteredNotifications = () => {
  ...
  return (
     ...
     <UserTop
        ...
        onCartClick={() => router.push("/cart")}   // ✅ go to /cart page
      />
   <div 
  style={{
    display: "flex",
...
>
  ...
  >
    ...
    <img src={savedaddress} width={30} height={30} alt="Saved Address"   onClick={() => router.push('/useraddress')}
    />
  </div>
              </div>
...
>
  ...
  note.type === "combo" ? (
    ...
    <div
      key={`${note.notification_id}-${index}`}
      className="notification-cards"
      onClick={() => {
        setSelectedNotification(note);
        fetchNotificationById(note.notification_id);
...
>
  ...
  <Modal.Body style={{ maxHeight: "70vh", overflowY: "auto" }}>
    {/* ✅ Move your Owner Details content here */}
    <div className="p-3">
      {/* Owner Name */}
      ...
      <div className="d-flex align-items-center mb-3">
        ...
        <span>{packageNotifications?.business?.business_name}</span>
      </div>
      <hr />
      ...
      <div className="d-flex align-items-center mb-3">
        ...
        <span>{packageNotifications?.business?.business_mobile}</span>
      </div>
      <hr />
  ...
  window.open(
    ...
    "_blank"
              ...
              <div className="d-flex gap-3 px-4 mb-4">
                ...
                >
                  <img src={ncalling} alt='call' width={24} height={24} className='me-3' /> <span style={{ fontFamily: "Manrope", fontSize: "16px", fontWeight: "700", lineHeight: "26px", color: "#FFFFFF" }} >Call</span>
                </a>
              </div>
            </div>
          )}
